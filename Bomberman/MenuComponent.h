...
namespace dae
{
	...
	{
	public:
		MenuComponent(Scene* scene, std::function<void(MathLib::GameMode gm, int levelIndex)> createLevel, std::function<void()> createHighscoreScreen, std::vector<glm::vec2> cursorLocations, MathLib::GameMode gamemode = MathLib::GameMode::SOLO) : m_Scene{ scene }, CreateLevel{ createLevel }, CreateHighscoreMenu{ createHighscoreScreen }, m_CursorLocations{ cursorLocations }, m_SelectedGameMode{ gamemode } {};
